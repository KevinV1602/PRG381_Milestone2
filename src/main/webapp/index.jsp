...
<body>
    <header class="main-header">
        <div class="header-content">
            ...
            <nav class="main-nav">
                <ul>
                    <li><a href="login.jsp" class="nav-button nav-login-btn">Login</a></li>
                    <li><a href="register.jsp" class="nav-button nav-register-btn">Sign Up</a></li>
                </ul>
            </nav>
        </div>
    </header>
    ...
    <main class="main-content">
        <div class="container">
            ...
            <p class="central-message">
                Your dedicated platform to manage wellness services.
            </p>
        </div>
    </main>
